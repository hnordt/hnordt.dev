...
<main inert={!dev} aria-hidden={dev ? undefined : "true"}>
  <Section>
    ...
    <p class="mt-4 text-lg font-medium text-pretty text-zinc-500">
      ...
      senior TypeScript execution and careful attention to detail.
    </p>
    ...
    <!-- <p class="mt-16 text-lg font-medium text-pretty text-zinc-500">
      An app is worth a thousand words. Try the demo above before reading on. It
      shows how I think about product quality, interaction details, and
